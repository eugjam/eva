...
{
    /**
     * @var \Tight\Eva\Controller\CategoryController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Tight\Eva\Controller\CategoryController::class)
    ...
    public function listActionFetchesAllCategoriesFromRepositoryAndAssignsThemToView()
    {
        ...
        $categoryRepository = $this->getMockBuilder(\Tight\Eva\Domain\Repository\CategoryRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
